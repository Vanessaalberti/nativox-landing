...
- La portada muestra subtítulos en tiempo real con Whisper en Workers AI: hasta 15 s por prueba, cortes en pausas de ~1,5 a 2 s con texto provisorio casi invisible y confirmación al cerrar la frase, 3 pruebas por dispositivo cada 24 h (el servidor cuenta segundos de audio facturado), ícono de "detener" y cuenta regresiva.
