...
export const TEXTOS_EVALUACION: Record<Idioma, TextosEvaluacion> = {
  es: {
    ...
    intro:
      "Un clic: revisamos tu placa de video, tu memoria y tu procesador, y medimos cuánta potencia tiene (unos segundos, sin descargar nada ni usar el micrófono). Con eso te recomendamos cómo usarla y te dejamos elegido el nivel de velocidad.",
    pasos: [
      "Revisar tu placa de video, tu memoria y tu procesador",
    ...
    detectando: "Revisando tu placa de video, tu memoria y tu procesador…",
  ...
  en: {
    ...
    intro:
      "One click: we check your graphics card, your memory and your processor, and measure how powerful the card is (a few seconds, no downloads and no microphone). With that we recommend how to use it and pick the speed level for you.",
    pasos: [
      "Check your graphics card, memory and processor",
      "Measure the card's power (a few seconds)",
      "Recommend how to use it",
    ],
    evaluar: "Check my computer",
    reevaluar: "Check again",
    detectando: "Checking your graphics card, memory and processor…",
  ...
  pt: {
    ...
    intro:
      "Um clique: verificamos a sua placa de vídeo, a sua memória e o seu processador, e medimos quanta potência ela tem (alguns segundos, sem baixar nada e sem usar o microfone). Com isso recomendamos como usá-la e já deixamos escolhido o nível de velocidade.",
    pasos: [
      "Verificar a sua placa de vídeo, a memória e o processador",
      "Medir a potência da placa (alguns segundos)",
      "Recomendar como usá-la",
    ],
    evaluar: "Avaliar o meu computador",
    reevaluar: "Avaliar de novo",
    detectando: "Verificando a sua placa de vídeo, a memória e o processador…",
