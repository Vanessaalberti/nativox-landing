...
| `resultados/` | Lo medido de cada combinación (JSON), con la fuente de cada número. Hoy se carga desde las mediciones del laboratorio; lo va a generar `scripts/informe-calidad` (paso 12). Lo que no está acá, la página lo muestra como "a medir" |
