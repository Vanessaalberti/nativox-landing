...
- **Resultado:** `comparacion/resultados/*.json`, que la página lee. Hoy se carga a mano desde mediciones propias (24/09/2026, placa AMD sin 16 bits) y cada número trae su `fuente`. Se mide una vez: la página no gasta nada. Lo que no se midió se muestra como "a medir".
